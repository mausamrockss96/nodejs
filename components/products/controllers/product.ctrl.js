...
function findAll(req,res,next)     // findAll for update

{
    console.log('req.property>>', req.loggedInUser);    //from authenticate.js middleware
    //business logic
...
function searchByPost(req, res, next)
{
    ...
    var searchCondition = productQuery.map_product_request(condition,req.boody)   
    console.log('search Condition>>', searchCondition);
    productQuery.find(searchCondition)  
    .then(function(data)
    {
